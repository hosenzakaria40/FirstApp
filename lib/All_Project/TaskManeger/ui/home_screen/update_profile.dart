      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            UserInput(controller: nameController, hintText: 'Full Name', keyboardType: TextInputType.text, labelText: 'Name',),
            UserInput(controller: emailController, hintText: 'Enter Email', keyboardType: TextInputType.text, labelText: 'Email',),
            UserInput(controller: phoneController, hintText: 'Enter Phone', keyboardType: TextInputType.text, labelText: 'Phone',),
