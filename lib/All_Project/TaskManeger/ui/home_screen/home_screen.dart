      ...
      bottomNavigationBar: NavigationBar(
        ...
        destinations: [
          NavigationDestination(
            icon: Icon(Icons.task, color: AppColor.primaryIcon),
            label: 'New Task',
          ),

          NavigationDestination(
            icon: Icon(Icons.refresh, color: AppColor.primaryIcon),
            label: 'Progress',
          ),

          NavigationDestination(
            icon: Icon(Icons.task_alt_outlined, color: AppColor.primaryIcon),
            label: 'Completed',
          ),
          NavigationDestination(
            icon: Icon(Icons.cancel_outlined, color: AppColor.primaryIcon),
            label: 'Canceled',
          ),

          NavigationDestination(
            icon: Icon(Icons.person, color: AppColor.primaryIcon),
            label: 'Profile',
          ),
        ],
      ),
