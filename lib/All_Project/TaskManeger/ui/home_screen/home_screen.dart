...
class _HomeScreenState extends State<HomeScreen> {
  ...
  List<Widget> get pages => [
    TaskScreen(taskList:All_taskList,status: 'New Task',),
    ProgressScreen(taskList: All_taskList,status: 'Progress',),
    CompletedScreen(taskList: All_taskList,status: 'Completed',),
    CanceledScreen(taskList: All_taskList,status: 'Canceled',),
    ProfileScreen(),
  ];
